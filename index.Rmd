...
pooler[7,"Wins"] <- pooler[7,"Wins"] + 1
pooler[7,"Points"] <- pooler[7,"Points"] + 3
pooler[7,"Holes Won"] <- pooler[7,"Holes Won"] + 10
pooler[4,"Losses"] <- pooler[4,"Losses"] + 1
pooler[4,"Holes Won"] <- pooler[4,"Holes Won"] + 8  

## O'Donnell/Ryan def. Markman/Notaney, 10.5 - 7.5
pooler[2,"Wins"] <- pooler[2,"Wins"] + 1
pooler[2,"Points"] <- pooler[2,"Points"] + 3
pooler[2,"Holes Won"] <- pooler[2,"Holes Won"] + 10.5
pooler[5,"Losses"] <- pooler[5,"Losses"] + 1
pooler[5,"Holes Won"] <- pooler[5,"Holes Won"] + 7.5  

## Simpson/Solomon def. Blom/Boone, 9.5 - 0
pooler[11,"Wins"] <- pooler[11,"Wins"] + 1
pooler[11,"Points"] <- pooler[11,"Points"] + 3
pooler[11,"Holes Won"] <- pooler[11,"Holes Won"] + 9.5
pooler[19,"Losses"] <- pooler[19,"Losses"] + 1
pooler[19,"Holes Won"] <- pooler[19,"Holes Won"] + 0  

## Markman/Notaney def. Cook/Sokitch, 9.5 - 8.5
pooler[5,"Wins"] <- pooler[5,"Wins"] + 1
pooler[5,"Points"] <- pooler[5,"Points"] + 3
pooler[5,"Holes Won"] <- pooler[5,"Holes Won"] + 9.5
pooler[15,"Losses"] <- pooler[15,"Losses"] + 1
pooler[15,"Holes Won"] <- pooler[15,"Holes Won"] + 8.5  

## Goodman/Momota def. Ota/Yeh, 11.5 - 6.5
pooler[6,"Wins"] <- pooler[6,"Wins"] + 1
pooler[6,"Points"] <- pooler[6,"Points"] + 3
pooler[6,"Holes Won"] <- pooler[6,"Holes Won"] + 11.5
pooler[12,"Losses"] <- pooler[12,"Losses"] + 1
pooler[12,"Holes Won"] <- pooler[12,"Holes Won"] + 6.5

## Petterson/Beauduy def. Ota/Yeh, 11 - 7
pooler[8,"Wins"] <- pooler[8,"Wins"] + 1
pooler[8,"Points"] <- pooler[8,"Points"] + 3
pooler[8,"Holes Won"] <- pooler[8,"Holes Won"] + 11
pooler[12,"Losses"] <- pooler[12,"Losses"] + 1
pooler[12,"Holes Won"] <- pooler[12,"Holes Won"] + 7

## Wellbeloved/Rovetti halve with Brennan/Henderson, 9 - 9 
pooler[16,"Ties"] <- pooler[16,"Ties"] + 1
pooler[16,"Points"] <- pooler[16,"Points"] + 1
pooler[16,"Holes Won"] <- pooler[16,"Holes Won"] + 9
pooler[18,"Ties"] <- pooler[18,"Ties"] + 1
pooler[18,"Points"] <- pooler[18,"Points"] + 1
pooler[18,"Holes Won"] <- pooler[18,"Holes Won"] + 9 

## Shirbroun/Clifford def. O'Donnell/Ryan, 9.5 - 8.5 (1 up)  
pooler[10,"Wins"] <- pooler[10,"Wins"] + 1
pooler[10,"Points"] <- pooler[10,"Points"] + 3
pooler[10,"Holes Won"] <- pooler[10,"Holes Won"] + 9.5
pooler[2,"Losses"] <- pooler[2,"Losses"] + 1
pooler[2,"Holes Won"] <- pooler[2,"Holes Won"] + 8.5

## Shirbroun/Clifford def. Markman/Notaney, 11.5 - 6.5 (4&3) 
pooler[10,"Wins"] <- pooler[10,"Wins"] + 1
pooler[10,"Points"] <- pooler[10,"Points"] + 3
pooler[10,"Holes Won"] <- pooler[10,"Holes Won"] + 11.5
pooler[5,"Losses"] <- pooler[5,"Losses"] + 1
pooler[5,"Holes Won"] <- pooler[5,"Holes Won"] + 6.5  

## Brennan/Henderson def. Sodergren/Hubregsen, 11 - 7
pooler[18,"Wins"] <- pooler[18,"Wins"] + 1
pooler[18,"Points"] <- pooler[18,"Points"] + 3
pooler[18,"Holes Won"] <- pooler[18,"Holes Won"] + 11
pooler[9,"Losses"] <- pooler[9,"Losses"] + 1
pooler[9,"Holes Won"] <- pooler[9,"Holes Won"] + 7

## Goodman/Momota def. Pettersson/Beauduy, 10 - 8  
pooler[6,"Wins"] <- pooler[6,"Wins"] + 1
pooler[6,"Points"] <- pooler[6,"Points"] + 3
pooler[6,"Holes Won"] <- pooler[6,"Holes Won"] + 10
pooler[8,"Losses"] <- pooler[8,"Losses"] + 1
pooler[8,"Holes Won"] <- pooler[8,"Holes Won"] + 8

## Cook/Sokitch def. Shirbroun/Clifford, 10 - 8
pooler[15,"Wins"] <- pooler[15,"Wins"] + 1
pooler[15,"Points"] <- pooler[15,"Points"] + 3
pooler[15,"Holes Won"] <- pooler[15,"Holes Won"] + 10
pooler[10,"Losses"] <- pooler[10,"Losses"] + 1
pooler[10,"Holes Won"] <- pooler[10,"Holes Won"] + 8  

## Petterson/Beauduy def. Dhadhal/Tao, 10 - 8
pooler[8,"Wins"] <- pooler[8,"Wins"] + 1
pooler[8,"Points"] <- pooler[8,"Points"] + 3
pooler[8,"Holes Won"] <- pooler[8,"Holes Won"] + 10
pooler[14,"Losses"] <- pooler[14,"Losses"] + 1
pooler[14,"Holes Won"] <- pooler[14,"Holes Won"] + 8  

## Wellbeloved/Rovetti def. Sodergren/Hubregsen, 11.5 - 6.5
pooler[16,"Wins"] <- pooler[16,"Wins"] + 1
pooler[16,"Points"] <- pooler[16,"Points"] + 3
pooler[16,"Holes Won"] <- pooler[16,"Holes Won"] + 11.5
pooler[9,"Losses"] <- pooler[9,"Losses"] + 1
pooler[9,"Holes Won"] <- pooler[9,"Holes Won"] + 6.5

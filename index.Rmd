...
# * 9/26 - Rovetti/Wellbeloved def. Moore/Vines, 9.5 - 8.5 (1 up)  

pooler <- giveRes(pooler, 24, 23, 9.5, 8.5)  

# * 9/28 - Markman/Notaney def. Momota/Goodman, 10 - 8 (2 and 1)  

pooler <- giveRes(pooler, 5, 22, 10, 8)  

# * 9/30 - Costello/Daly def. Beer/Debruyn, 13 - 5 (7 and 6)  

pooler <- giveRes(pooler, 6, 21, 13, 5)  

# * 10/1 - Cook/Sokitch halved with Kahn/Lee, 9 - 9 (AS)  

pooler <- giveRes(pooler, 1, 16, 9, 9)  

# * 10/2 - Solomon/Simpson def. Kahn/Lee, 11 - 7 (5 and 4)  

pooler <- giveRes(pooler, 13, 16, 11, 7)  

# * 10/3 - Rovetti/Wellbeloved def. Mellinger/Selmi, 10 - 8 (2 and 1)  

pooler <- giveRes(pooler, 24, 2, 10, 8)  

# * 10/4 - Kahn/Lee def. Petterson/Beaduy, 9.5 - 0 (Conceded)  

pooler <- giveRes(pooler, 16, 12, 9.5, 0)  
...
* `r seeds[8]` vs `r seeds[11]`  
    +  3/25 -- `r seeds[8]` def. `r seeds[11]`, 2 up


###Semifinals  

*  `r seeds[8]` vs `r seeds[4]`  
    +  1/21 -- `r seeds[8]` def. `r seeds[4]`, 19 holes  
    
*  `r seeds[10]` vs `r seeds[11]`  
    + 1/21 -- `r seeds[11]` def. `r seeds[10]`, 4 and 3  


###Quarterfinals  

*  `r seeds[1]` vs `r seeds[8]`  
    + 12/16 -- `r seeds[8]` def. `r seeds[1]`, 19 holes  
    
*  `r seeds[2]` vs `r seeds[10]`  
    + 12/17 -- `r seeds[10]` def. `r seeds[2]`, 4 and 3  
    
*  `r seeds[3]` vs `r seeds[11]` 
    +  11/26 -- `r seeds[11]` def. `r seeds[3]`, 4 and 3  
    
*  `r seeds[4]` vs `r seeds[12]`  
    +  12/3 -- `r seeds[4]` def. `r seeds[12]`, 3 and 2  
...
*  `r seeds[5]` vs `r seeds[12]`  
    +  11/5 -- `r seeds[12]` def. `r seeds[5]`, 2 up  

*  `r seeds[6]` vs `r seeds[11]`  
    +  10/29 -- `r seeds [11]` def. `r seeds[6]`, 4 and 3  
    
*  `r seeds[7]` vs `r seeds[10]`  
    +  10/29 -- `r seeds[10]` def. `r seeds[7]`, 1 up  
    
*  `r seeds[8]` vs `r seeds[9]`  
    +  10/28 -- `r seeds[8]` def. `r seeds[9]`, 6 and 5  

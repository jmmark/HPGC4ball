...
###Final  
*  `r seeds[5]` vs `r seeds[6]`  
        +  3/30 - `r seeds[6]` def `r seeds[5]`, 1 up


###Semifinals  

*  Semifinal 1: `r seeds[8]` vs `r seeds[5]`  
    +  12/22 - `r seeds[5]` def `r seeds[8]`, 3 and 1  
    
*  Semifinal 2: `r seeds[2]` vs `r seeds[6]` 
    +  12/14 - `r seeds[6]` def `r seeds[2]`, 21 holes

###Quarterfinals  

* Quarterfinal 1: `r seeds[1]` vs `r seeds[8]`  
    +  11/6 - `r seeds [8]` def `r seeds[1]`, 2 and 1
* Quarterfinal 2: `r seeds[2]` vs `r seeds[7]`  
    +  11/2 - `r seeds[2]` def `r seeds[7]`, 1 up
* Quarterfinal 3: `r seeds[3]` vs `r seeds[6]`  
    +  10/23 - `r seeds[6]` def `r seeds[3]`, 19 holes
* Quarterfinal 4: `r seeds[4]` vs `r seeds[5]`  
    +  10/23 - `r seeds[5]` def `r seeds[4]`, 2 and 1
